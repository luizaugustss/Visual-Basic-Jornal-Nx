...
'
'       Filename:  C:\Users\LUIZ\Desktop\programação\ui\Ferramentas.vb
'
'        This file was generated by the NX Block UI Styler
'        Created by: LUIZ
'              Version: NX 12
'              Date: 02-28-2023  (Format: mm-dd-yyyy)
'              Time: 16:46 (Format: hh-mm)
'
'==============================================================================
...
Public Class Ferramentas
    ...
    Dim Machine As NXOpen.CAM.NcGroup
...
#Region "Block Styler Dialog Designer generator code"
    ...
    Public Sub New()
        Try
            ...
            'theUI = UI.GetUI()
            theDlxFileName = Environ("userprofile") & "\Desktop\programação\UI\Ferramentas.dlx"
...
#End Region
    ...
    Public Shared Sub Main()
        Dim theFerramentas As Ferramentas = Nothing
        Try
        
            theFerramentas = New Ferramentas()
        ...
        Finally
            If theFerramentas IsNot Nothing Then 
                theFerramentas.Dispose()
                theFerramentas = Nothing
            End If
        End Try
    End Sub
    '------------------------------------------------------------------------------
    ...
    Public Sub initialize_cb()
        Try
            ...
            Machine = CType(workPart.CAMSetup.CAMGroupCollection.FindObject("GENERIC_MACHINE"), NXOpen.CAM.NcGroup)
            Dim ini_value(Machine.GetMembers().Length - 2) As String
            For i As Integer = 0 To Machine.GetMembers().Length - 2
                ini_value(i) = Machine.GetMembers()(i + 1).Name

            Next

            enum01.SetEnumMembers(ini_value)
        Catch ex As Exception
    ...
    Public Function update_cb(ByVal block As NXOpen.BlockStyler.UIBlock) As Integer
        Try
            ...
            ElseIf block Is enum02 Then
                ...
                '---- Enter your code here -----
                cont += 1
                Dim enum_members(enum01.GetEnumMembers().Length) As String
                enum01.GetEnumMembers().CopyTo(enum_members, 0)

                enum_members(enum01.GetEnumMembers().Length) = (cont & "__" & Machine.Name)
                enum01.SetEnumMembers(enum_members)
                ' theUI.NXMessageBox.Show("Block Styler", NXMessageBox.DialogType.Error, enum01.GetEnumMembers().Length)
                theUI.NXMessageBox.Show("Block Styler", NXMessageBox.DialogType.Error, Machine.Name)
